      ...
      <div className="container px-6 prose min-w-full mx-auto my-20">
        ...
        <div className="grid md:grid-cols-2  gap-4 grid-cols-none">
          ...
          <div className="w-full p-28 text-center">
            ...
            <span className='text-1xl'>Meaning: {wordsAPIRes.meaning}</span><br />
            <span>Furigana: {wordsAPIRes.furigana}</span><br />
            <span>Romaji: {wordsAPIRes.romaji}</span><br />
            <span>Level: {wordsAPIRes.level}</span>
          </div>
        </div>
