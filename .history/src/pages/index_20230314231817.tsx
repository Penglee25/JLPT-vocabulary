      ...
      <div className="container px-6 prose min-w-full mx-auto my-20">
        ...
        <div className="grid md:grid-cols-2  gap-4 grid-cols-none">
          ...
          <div className="w-full p-28 text-center">
            ...
            <span>Meaning: {wordsAPIRes.meaning}</span><br />
            <span>Fugirana: {wordsAPIRes.fujirana}</span><br />
            <span>Romanji: {wordsAPIRes.romanji}</span><br />
            <span>Romanji: {wordsAPIRes.romanji}</span>
          </div>
        </div>
