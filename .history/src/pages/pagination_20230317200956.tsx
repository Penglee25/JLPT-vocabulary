        ...
        <div>
            <div className="mb-10 w-3/6">
                <div className="relative">
                    ...
                    <input type="search" id="default-search" className=" outline-none block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Search JPLT words..." required />
                </div>
            </div>
