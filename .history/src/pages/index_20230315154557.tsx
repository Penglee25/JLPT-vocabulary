  ...
  return (
    <div className="">
      ...
      <div className="container px-6 prose min-w-full mx-auto my-20">
        ...
        <div className="grid md:grid-cols-5  gap-5 grid-cols-none mb-20">
          { N5 !== '' ?
            N5.map((item: any, i: keyof) => (
              <div key={} className="block rounded-lg bg-red-300 p-6 shadow-lg dark:bg-neutral-700">
