  ...
  return (
    <div style={{backgroundColor: '#091c29'}} className='fixed top-0 w-screen z-20'>
            <div className="w-10/12 mx-auto py-3 flex items-center justify-between text-white font-dosis">
                <ScrollLink to='home' smooth={true} className={`${animate? '': '-translate-x-20 opacity-0'} transform transition duration-2500 text-2xl font-bold cursor-pointer`} onClick={()=>window.location.reload()}>
                    <h3>{content.nav.logo}{' '}
